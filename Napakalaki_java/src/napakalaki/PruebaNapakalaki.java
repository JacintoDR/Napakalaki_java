...
public class PruebaNapakalaki {
    ...
    public static void main(String[] args) {
        ...
        badConsequence = new BadConsequence("Pierdes todos tus tesoros visibles", 0, 0);
        prize = new Prize(3,1);
        ...
        //Los hondos
        badConsequence = new BadConsequence("Estos monstruos resultan " +
        ...
        //Semillas Cthulhu
        badConsequence = new BadConsequence("Pierdes 2 niveles y 2 tesoros ocultos", 2, 2, false);
        prize = new Prize(2,1);
        ...
        //Pollipólipo volante
        badConsequence = new BadConsequence("Da mucho asquito. Pierdes 3 niveles", 3, 0, false);
        prize = new Prize(1,1);
